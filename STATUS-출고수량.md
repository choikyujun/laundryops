...
| 2026-09-11 | 수량 입력칸 폭 60px → **80px** (`#staffInvoiceBody .qty-input` `!important`) | 3자리(100 단위)가 잘림. `app_v38.js:3197` 인라인 style 을 CSS `!important` 로 덮음(직접 수정 금지) | 사장님 |
...
- 실제 Chrome 레이아웃 측정(헤드리스, 320/360/1280px): 25/25 통과
  ...
  - 수량칸 80px 이 6열/5열/모든 뷰포트에서 인라인 60px 를 덮음
